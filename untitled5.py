...
Original file is located at
    https://colab.research.google.com/drive/1zGjJuLzN8QihcQfVW2hUFlT28TsgMQEm
"""
...
# 1. Define your paths
# Note: Ensure the filename 'DATASET.zip' matches exactly (case-sensitive)
drive_path = '/content/drive/MyDrive/CLIP/DATASET.zip'
local_path = '/content/DATASET.zip'
extraction_path = '/content/dataset_images'

# 2. Copy the file from Drive to Local Disk
if os.path.exists(drive_path):
    print("Transferring ZIP from Drive to local SSD...")
    shutil.copyfile(drive_path, local_path)
    print("Transfer complete.")
else:
    print(f"Error: Could not find {drive_path}. Check your filename in Drive.")

# 3. Unzip the file
# The -q flag is "quiet" mode, which is necessary for 120k files
# otherwise Colab will crash trying to print all the filenames.
print("Unzipping 120,000 images... This will take a few minutes.")
!unzip -q {local_path} -d {extraction_path}
